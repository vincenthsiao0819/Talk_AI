...
def wait_for_mac_tunnel():
    ...
    try:
        ...
        # "系統連線成功，隨時待命"
        ready_text = bytes([231, 179, 187, 231, 181, 177, 233, 128, 163, 231, 183, 154, 230, 136, 144, 229, 138, 159, 239, 188, 140, 233, 154, 168, 230, 153, 130, 229, 190, 133, 229, 145, 189]).decode("utf-8")
